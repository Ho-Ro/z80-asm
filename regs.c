...
const char *reg_name[ N_REGISTERS + 1 ] = { "",    "A", "B", "C",  "D",  "E",  "H",  "L",  "IXh", "IXl", "IYh",
                                            "IYl", "I", "R", "AF", "BC", "DE", "HL", "SP", "IX",  "IY",  "AF'" };

const struct seznam_type reg[ N_REGISTERS ] = { /* sorted lexicographically */
                                                { "A", R_A },     { "AF", R_AF },   { "AF'", R_AF_ }, { "B", R_B },
                                                { "BC", R_BC },   { "C", R_C },     { "D", R_D },     { "DE", R_DE },
                                                { "E", R_E },     { "H", R_H },     { "HL", R_HL },   { "I", R_I },
                                                { "IX", R_IX },   { "IXh", R_IXh }, { "IXl", R_IXl }, { "IY", R_IY },
                                                { "IYh", R_IYh }, { "IYl", R_IYl }, { "L", R_L },     { "R", R_R },
                                                { "SP", R_SP } };
...
const struct seznam_type flag[ N_FLAGS ] = { /* sorted lexicographically */
                                             { "C", F_C }, { "M", F_M },   { "NC", F_NC }, { "NZ", F_NZ },
                                             { "P", F_P }, { "PE", F_PE }, { "PO", F_PO }, { "Z", F_Z } };
